...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "A Great and Mighty Wonder"  }
  meter = \markup { \small { Music: ES IST EIN' ROS' ENTSPRUNGEN, 76.76.676.; German, harm. M. Praetorius } }
  piece = \markup { \small {Text: Μέγα χαί παράδοξον θαυμα, St. Germanus, 734; tr. J.M. Neale, 1862, alt. }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
...
verseOne = \lyricmode {
  \set stanza = "1."
  \tagIt A great and might -- y won -- der
  \tagIt A full and ho -- ly cure!
  \tagIt The Vir -- gin bears the In -- fant
  \tagIt With vir -- gin -- hon -- our pure.
