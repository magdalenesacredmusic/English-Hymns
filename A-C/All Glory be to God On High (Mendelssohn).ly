...
refs = \markup {
  \fontsize #-3 {
    \left-column {
      \wordwrap {
        Text: \italic "Allein Gott in der Höh sei Ehr," Nikolaus Decius, 1525; Tr. C. Winkworth, 1863, alt.
      }
      \wordwrap {
        Music: ALLEIN GOTT IN DER HÖH' SEI EHR, 87 87 887, Leipzig, 1539; Arr. Felix Mendelssohn, 1863
      }
    }
  }
}
