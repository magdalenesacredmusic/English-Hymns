...
refs = \markup {
  \fontsize #-3 {
    \left-column {
      \wordwrap {
        Text: \italic "Quicumque certum quaeritis," 18th cent.; Tr. Edward Caswall, alt. \italic "The English Hymnal"
      }
      \wordwrap {
        Music: ST. BERNARD, CM, \italic "Tochter Sion," 1741; Arr. John Richardson (1816-1879), 1863
      }
    }
  }
}
