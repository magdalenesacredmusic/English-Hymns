...
top = \markup {
  \fill-line {
    \column {
      \line {CONDITOR ALME SIDERUM  LM}
    }
    \right-column{
      \line {Mode IV, Roman Use}
...
melody = \relative c'' {
  ...
  bf8 c af bf af \bar "" g f g4 \once \override ChoirStaff.BarLine.bar-extent = #'( -1 . 1 )
  \bar "|"
...
melodya = \relative c'' {
  ...
  g4 ef g bf bf c af bf \bar "'" 
  bf4 c af bf af g f g2 \once \override ChoirStaff.BarLine.bar-extent = #'( -1 . 1 )
  \bar "|"
  bf4 af f g af g f ef \bar "'" 
  ef4 g af bf af g f g2 \bar "||" \break
