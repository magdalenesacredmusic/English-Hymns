...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "At the Name of Jesus"  }
  meter = \markup { \small { Music: KING'S WESTON, 65.65. D.; R. Vaughan Williams, 1925} }
  piece = \markup { \small {Text: C.M. Noel, 1870 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
