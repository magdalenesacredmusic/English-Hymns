...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "Guide Me, O Thou Great Redeemer"  }
  meter = \markup { \small { Music: CWM RHONDDA, 87 87 44 77, John Hughes, 1907 } }
  piece = \markup { \small {Text: William Williams, 1745; \italic "tr. from the Welsh by" Peter Williams}}
  %breakbefore
  %copyright = ""
  tagline = ""
}
