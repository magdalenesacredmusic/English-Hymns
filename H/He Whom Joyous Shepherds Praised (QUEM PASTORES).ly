...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "He Whom Joyous Shepherds Praised"  }
  meter = \markup { \small { Music: QUEM PASTORES, 888.7.; Hohenfurth Manuscript, 1410; harm. \italic "The Hymnal," 1940 } }
  piece = \markup { \small {Text: \italic "Quem pastores laudavere," ca. 1410; tr. C.W. Douglas, 1940 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
