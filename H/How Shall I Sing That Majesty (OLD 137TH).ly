...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "How Shall I Sing That Majesty"  }
  meter = \markup { \small { Music: OLD 137TH, D.C.M.; Day's Psalter, 1563} }
  piece = \markup { \small {Text: John Mason, c. 1683 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
