...
refs = \markup {
  \fontsize #-3 {
    \left-column {
      \wordwrap {
        Text: Σιγησάτο παρα σὰρξ βροτεία, Liturgy of St. James; Tr. Gerard Moultrie (1829-85), 1864
      }
      \wordwrap {
        Music: PICARDY 87 87 87, French Melody; Harm. \italic "The English Hymnal," 1906
      }
    }
  }
}
