...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "Let Sighing Cease and Woe"  }
  meter = \markup { \small { Music: ST. MICHAEL (OLD 134TH), S.M.; L. Bourgeois, \italic "Genevan Psalter," 1551; adapt. W. Crotch } }
  piece = \markup { \small {Text: \italic "Jam desinant suspiria," C. Coffin; tr. W.J. Blew }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
