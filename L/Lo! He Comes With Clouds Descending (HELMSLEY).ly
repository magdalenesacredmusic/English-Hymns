...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "Lo! He Comes With Clouds Descending"  }
  meter = \markup { \small { Music: HELMSLEY, 8.7.8.7.4.7, attr. T. Olivers; \italic "The English Hymnal"} }
