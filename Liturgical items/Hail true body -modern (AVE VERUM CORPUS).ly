...
bottom = \markup  {
  \fill-line {
    ...
    \right-column {
      ...
      \line {Tr. Henry Nutcombe Oxenham (1829-1888), alt.}
    }
  }
}
...
melodya = \relative c'' {
  ...
  g4( a b) g a g2 c4 b a b2 \mhb
  a4 g fs g a( b) a a2( g) \bar "||"
  
  g4( a b) g a g2 c4 b a b2 \mhb
  a4 g fs g a( b) a a2( g) \bar "||"
  
  b4 d e d2 c4 b a( g a) b2 \mhb \break
...
You who on the Cross were of -- fered
To re -- deem the Sons of earth;
You whose side be -- came a foun -- tain
Pour -- ing forth your pre -- cious blood,
