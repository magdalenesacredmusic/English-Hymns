...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "Now My Soul, Thy Voice Uprising"  }
  meter = \markup { \small { Music: ST. THOMAS, 87.87.87; J.F. Wade, 1751 } }
  piece = \markup { \small {Text: \italic "Prome vocem, mens, canoram," Claude de Santeüil; tr. H.W. Baker and J. Chandler }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
