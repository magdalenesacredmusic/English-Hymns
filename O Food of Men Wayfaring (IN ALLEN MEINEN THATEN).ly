...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "O Food of Men Wayfaring"  }
  meter = \markup { \small { Music: IN ALLEN MEINEN THATEN, 776.D.; \italic "Zions Harfe," 1855 } }
  piece = \markup { \small {Text: \italic "O esca viaatorum," 17th cent.; tr. A. Riley, 1906 }}
  %breakbefore
  %copyright = ""
  tagline = ""
