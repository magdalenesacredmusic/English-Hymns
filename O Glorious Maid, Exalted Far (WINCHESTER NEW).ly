...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "O Glorious Maid, Exalted Far"  }
  meter = \markup { \small { Music: WINCHESTER NEW, L.M.; \italic "Musikalisches Hand-buch," 1690; \italic "The English Hymnal," 1906} }
  piece = \markup { \small {Text: \italic "O gloriosa Femina," Venantius Fortunatus; tr. Percy Dearmer, 1906 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
