...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "O Word Immortal of Eternal God"  }
  meter = \markup { \small { Music: SONG 24, 10.10.10.10.; O Gibbons, 1623; arr. R. Vaughan Williams, 1906} }
  piece = \markup { \small {Text: \italic "Ὁ μονογενὴς ϒιός," Emperor Justinian; tr. T.A. Lacey, 1906 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
