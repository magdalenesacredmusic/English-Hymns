...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "O Word of God Incarnate"  }
  meter = \markup { \small { Music: MUNICH 76.76.D.; Meiningen, 1693; harm. F. Mendelssohn, 1847 } }
  piece = \markup { \small {Text: W.W. How, 1867 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
