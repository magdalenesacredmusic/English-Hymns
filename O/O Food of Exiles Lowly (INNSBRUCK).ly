...
top = \markup {
  \fill-line {
    \column {
      \line {INNSBRUCK 77 67 76}
    }
    \right-column{
      \line {H. Isaak; harm. J.S. Bach, \italic "Episcopal Hymnal," 1906, alt.}
    }
  }
}
...
bottom = \markup  {
  \fill-line {
    \null 
    \right-column {
      \line {\italic "O esca viatorum," \italic "Maintzisch Gesangbuch"}
      \line {tr. M. Owen Lee, \italic "The New St. Basil Hymnal," alt.}
    }
  } 
}
