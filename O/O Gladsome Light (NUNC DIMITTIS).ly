...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "O Gladsom Light"  }
  meter = \markup { \small { Music: NUNC DIMITTIS, 6.6.7. D, L. Bourgeois, 1549; harm. C. Goudimel, adapt.; \italic "The English Hymnal" } }
  piece = \markup { \small {Text: Φῶς Ἱλαρόν \italic "(Phos hilaron)," Ancient Greek hymn; trans. Robert S. Bridges, 1899 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
