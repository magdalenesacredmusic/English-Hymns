...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "O Praise Ye the Lord"  }
  meter = \markup { \small { Music: LAUDATE DOMINUM, 10.10.11.11.; C.H.H. Parry, 1894 } }
  piece = \markup { \small {Text: H.W. Baker, \italic "Hymns Ancient and Modern," 1875 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
