...
\header {
   poet = \markup{ \fontsize #4 \smallCaps "O Sacred Head, Surrounded"  }
    meter = \markup { \small { Music: PASSION CHORALE, 76.76. D.; H.L. Hassler; arr. J.S. Bach } }
    piece = \markup { \small {Text: \italic "Salve caput cruentatum," St. Bernard; tr. H.W. Baker, \italic "Hymns Ancient and Modern" }}
    %breakbefore
    %copyright = ""
    tagline = ""
}
