...
\header {
  poet = \markup { \fontsize #4 \smallCaps "PRAISE TO THE HOLIEST IN THE HEIGHT" }
  meter = \markup { \small "Music: BILLING, 86.86; R.R. Terry, 1912" }
  piece = \markup { \small {Text: \italic "The Dream of Gerontius," John H. Newman, 1865 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
