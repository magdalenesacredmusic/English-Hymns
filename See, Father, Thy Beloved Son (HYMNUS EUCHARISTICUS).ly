...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "See, Father, Thy Beloved Son"  }
  meter = \markup { \small { Music: HYMNUS EUCHARISTICUS, L.M.; B. Rogers, (1614-1698) \italic "The English Hymnal"} }
  piece = \markup { \small {Text: vv. 1-2, W.H.H. Jervois, (1852-1905) }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
