...
\header {
   poet = \markup{ \fontsize #4 \smallCaps "The God Whom Earth and sea and sky"  }
    meter = \markup { \small { Music: EISENACH, L.M.; adapt. from J.H. Schein; harm. J.S. Bach } }
    piece = \markup { \small {Text: \italic "Quem terra, pontus, aethera," Venantius Fortunatus; tr. J.M. Neale  }}
    %breakbefore
    %copyright = ""
    tagline = ""
}
