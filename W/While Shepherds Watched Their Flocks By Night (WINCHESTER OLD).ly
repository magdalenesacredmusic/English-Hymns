...
\header {
  poet = \markup{ \fontsize #4 \smallCaps "While Shepherds Watched Their Flocks by Night"  }
  meter = \markup { \small { Music: WINCHESTER OLD, C.M.; Este's Psalter, 1592 } }
  piece = \markup { \small {Text: Nahum Tate, 1700 }}
  %breakbefore
  %copyright = ""
  tagline = ""
}
